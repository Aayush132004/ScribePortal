...
return (
    <div className={`min-h-screen ${baseClasses} transition-colors duration-300 font-sans`}>
        ...
        className="container mx-auto px-4 py-8 space-y-12">
               {/* Page level heading (WCAG): ensure a level-1 heading exists */}
  <h1
    id="page-title"
    className="sr-only md:not-sr-only text-3xl font-bold mb-6"
  >
    {t.mainContent}
  </h1>
    {/* ARIA fallback for tools that don't detect headings for some reason */}
  <div
    role="heading"
    aria-level="1"
    aria-hidden="true"
